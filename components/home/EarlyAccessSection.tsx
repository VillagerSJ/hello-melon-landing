      ...
      <div className="mx-auto w-full max-w-[1760px]">
        <div className="relative mx-auto w-full max-w-[1560px]">
          ...
          <Image
            ...
            width={328}
            height={260}
            className="pointer-events-none absolute bottom-[clamp(-10px,-0.8vw,-2px)] right-[clamp(-28px,-1.9vw,-10px)] z-20 h-auto w-[clamp(112px,13.5vw,238px)]"
          />
              ...
              <div className="order-2 mx-auto max-w-[760px] text-center lg:mx-0 lg:text-left">
                ...
                >
                  <span className="relative block w-[clamp(154px,14.5vw,232px)]">
                    ...
                    />
                    <span className="absolute inset-0 flex items-center justify-center font-solway text-[clamp(14px,1.45vw,30px)] font-bold leading-none tracking-[0.01em] text-melon-cream">

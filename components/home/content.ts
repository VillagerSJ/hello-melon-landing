...
export const HOME_COPY = {
  ...
  ribbonText: "A joyful new wellness world designed for warmth, trust, and gentle care.",
  heroLineOne: "This isn't a clinic.",
  heroLineTwo: "It's a village.",
  heroDescription:
    "Welcome to Hello Melon, where every visit feels safe, every check-in feels personal, and every record lives in a world designed just for you. Healthcare, reimagined with empathy first.",
  ctaLabel: "Plant your seed: Join the Founding Circle",
  exploreTitle: "Explore the Village",
  exploreSubtitle: "Step into your new wellness world",
  whyDifferentTitle: "Why It’s Different",
  whyDifferentSubtitle:
    "While others built systems for doctors, we built a village for you.",
  whyDifferentCards: [
    {
  ...
  voicesStripText: "Be part of the founding circle, help shape Melon Village",
  voicesCards: [
    {
      id: "p1",
  ...
  earlyAccessBody:
    "Join our first villagers and get exclusive early access. You’ll be the first to explore the village, meet your doctor-match, and shape the future of care.",
  earlyAccessCtaLabel: "Plant your seed",
  footerLinks: [
    {
      label: "Privacy",
      href: "#",
